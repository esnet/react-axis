...
exports.default = _react2.default.createClass({
    ...
    propTypes: {
         ...
         * ```
         */
        format: _react2.default.PropTypes.oneOfType([_react2.default.PropTypes.oneOf(["second", "minute", "day", "month", "year", "duration"]), _react2.default.PropTypes.func]),
    ...
    renderAxisTicks: function renderAxisTicks() {
        ...
        formatter = this.props.format || (0, _timeFormat2.default)(type, timezone);
