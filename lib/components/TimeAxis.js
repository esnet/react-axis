...
exports.default = _react2.default.createClass({
    ...
    propTypes: {
         ...
         * ```
         */
        format: _react2.default.PropTypes.oneOfType([_react2.default.PropTypes.oneOf(["second", "minute", "hour", "day", "month", "year", "duration"]), _react2.default.PropTypes.func]),
    ...
    renderAxisLabel: function renderAxisLabel() {
        ...
        return _react2.default.createElement(
            ...
            _react2.default.createElement(
                "text",
                { transform: rotate, textAnchor: anchor, style: labelStyle },
                this.props.label
            )
        );
    },
    ...
    renderAxisTicks: function renderAxisTicks() {
        ...
        var type = void 0,
            num = void 0;
        if (_underscore2.default.isString(formatter) && formatter !== "duration") {
            type = formatter;
            num = 1;
        } else {
