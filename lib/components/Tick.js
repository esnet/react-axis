...
exports.default = _react2.default.createClass({
    ...
    renderVerticalTick: function renderVerticalTick(id, label, labelPosition, size, extend, isTop) {
        ...
        return _react2.default.createElement(
            "g",
            { style: tickTransitionStyle, key: groupKey },
            _react2.default.createElement("line", _extends({ key: tickKey, className: "tick-line", style: style }, line)),
    ...
    render: function render() {
        var _props = this.props,
            ...
            _props$smoothTransiti = _props.smoothTransition,
            smoothTransition = _props$smoothTransiti === undefined ? false : _props$smoothTransiti;
        ...
        if (align === "top" || align === "bottom") {
            ...
            return _react2.default.createElement(
                "g",
                { style: smoothTransition ? { transform: transform, transition: transition } : { transform: transform } },
            ...
            return _react2.default.createElement(
                "g",
                { style: smoothTransition ? { transform: _transform, transition: transition } : { transform: _transform } },
